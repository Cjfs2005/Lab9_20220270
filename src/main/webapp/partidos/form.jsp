<%@ page import="com.example.lab9_20220270.Bean.Seleccion" %>
<%@ page import="com.example.lab9_20220270.Bean.Arbitro" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@page import="java.util.ArrayList" %>
<%
    ArrayList<com.example.lab9_20220270.Bean.Seleccion> selecciones = (ArrayList<Seleccion>) request.getAttribute("listaSelecciones");
%>
<%
    ArrayList<com.example.lab9_20220270.Bean.Arbitro> arbitros = (ArrayList<Arbitro>) request.getAttribute("listaArbitros");
%>
<html lang="es">
    <head>
